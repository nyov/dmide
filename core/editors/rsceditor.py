...
class DMIDE_RSCEditor(wxIconList.IconListCtrl):
		def __init__(self, root):
			wxIconList.IconListCtrl.__init__(self, root, style=wx.LC_ICON | wx.LC_VIRTUAL | wx.NO_BORDER | wx.CLIP_CHILDREN)
